...
ACTIVITY_EVALUATION_DATA_KEY: Final = f"{DOMAIN}_activity_evaluation"
...
CONF_FITNESS_FTP_WATTS: Final = "fitness_ftp_watts"
CONF_FITNESS_THRESHOLD_SPEED_MPS: Final = "fitness_threshold_speed_mps"
...
FITNESS_FTP_MIN: Final = 50
FITNESS_FTP_MAX: Final = 1000
FITNESS_THRESHOLD_SPEED_MIN: Final = 1.0
FITNESS_THRESHOLD_SPEED_MAX: Final = 10.0
